...
Firstly, EMF is a festival with live music, and a fully operational nightclub that is open to the air. This means the nearer you get to the top end of the site, the noisier it gets (in general). You can check out the map for other noise-making things, such as the Scottish Consulate (24 hr Buckfast-fuelled noise) and the Karaoke Tent. Villages will also make their own amounts of noise, from banging sound systems (they're usually on the top end of the site) to happy chatting people up until the wee hours discussing projects. You can usually spot them by small marquees or camping shelters with circles of chairs.

There are also music stages and a film tent that will be making noise until the amplified curfew (2am) at the latest. You can see these on the map. The film stage can start making noise from 0800 Friday-Sunday. The music stages can start making noise from 1100 Friday to Sunday. 

Stage A is due to finish at 2100 Friday and Saturday, and 1900 Sunday. Stage B is due to finish at 2300 Thursday-Saturday and 1800 Sunday. Stage C is the film tent and will be running until 2300 Thursday night, 0100 Friday and Saturday night, and midnight Sunday night. Stage D is music and will be running until 2300 Thursday, 0100 Friday and Saturday, and midnight Sunday night.

### Noise sensitivity?

All of these stages may overrun their hours slightly as these are the intended timings, but sometimes performances can overrun. Again, the site noise curfew is 0030 Thursday and Sunday, and 0200 Friday and Saturday. Here are the same intended operating hours as a table.

<table class="table about-what-to-expect-stage-timings">
  <thead>
    <tr>
      <th>Stage</th>
      <th>Thursday</th>
...
Finally, it is noisy EVERYWHERE on site. It just depends what's making it. Even down the bottom of the site you will hear wubwubwub until a maximum of 2am (the amplified noise curfew).

### Smell sensitivity?

Smell wise, if you have smell sensitivity avoid generators, the food vendors, camping near anything marked as backstage, and possibly the lake depending on algae levels.

If it is dry, camping near trackway will probably result in a very dusty tent (be aware if dust affects you). The trackway is also lit at night.

### Accessibility needs?

We have an area of accessible camping which is near the accessible facilities (toilets and showers). We've asked villages not to set up in this space to ensure room is left for those with either a need to be within quick reach of the facilities, or to have extra space/walkway between tents. You can decide whether you need this, we don't police it as some disabilities are invisible and it's hard enough without having red tape. If you have any questions, worries, or special requests, we're just an email away (<a href="mailto:contact@emfcamp.org">contact@emfcamp.org</a>).
...
<a href="https://phones.emfcamp.org/phonebook" class="btn btn-primary">See the phonebook</a>
...
We have drinking water points throughout the site, and if you bring a refillable bottle you can keep topping it up and making sure you're hydrated.

If it's sunny, make sure you get some shade, in one of the tents or under the trees.

If you find yourself struggling with a task (eg taking down your tent), give info a call or drop in and we'll find you some help, no worries.

## What's with the ducks/spiders?

The ducks live on the ponds down the West side of the site. They can be rather noisy in the mornings, and so have a reputation as agents of chaos. One year (2022?) the field had an unseasonable large amount of money spiders, and they were great at hanging off microphones and distracting speakers. There is a rumour that they have attended that many talks that they are now a hyper-intelligent subspecies, and probably have their own nuclear programme.

## What are villages and do I need to be part of one?

A village is a place where people with a shared interest have decided to be. You'll see named blobs on the map that show roughly where they intend to camp. Some of them have a big shared tent they set up where they cook together and make things, others a circle of chairs, some are just friends who want to camp together!
...
<a href="/villages" class="btn btn-primary">See the Village list</a>
...
* Things that could be a risk to other attendees: something dangerous if you don't know what it is/what do with it, things that might overheat or catch fire not on purpose, etc. If in doubt, ask us.

## How should I behave?

We have a [Code of Conduct which you can find here](https://www.emfcamp.org/code-of-conduct/), please read it even if you think you've read one before.

Also, it's worth highlighting that if you're taking photos where you can recognise a person, it's expected that you ask them if that's ok, and delete it immediately if they want you to. Do not publish identifiable photos of people without their consent (this includes streaming or video calls).
...
Noise can theoretically happen here as per the noise table above, although Friday day can still be in setup and testing mode even if you're not allowed in yet. If you check the schedule closer to the date of the event, you'll be able to see precisely when there are artists and DJs.
