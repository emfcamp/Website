...
Firstly, EMF is a festival with live music, and a fully operational nightclub that is open to the air. This means the nearer you get to the top end of the site, the noisier it gets (in general). You can check out the map online or in your booklet for other noise-making things, such as Villages and the Karaoke Tent. Villages will also make their own amounts of noise, from banging sound systems (they're usually on the top end of the site) to happy chatting people up until the wee hours discussing projects. You can usually spot them by small marquees or camping shelters with circles of chairs.
...
<a href="https://map.emfcamp.org" class="btn btn-primary">See the map</a>
