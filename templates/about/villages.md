...
Village admins may also mark the location of their village on the map if they wish. To do this, make sure you're logged in on the main website, and go to [map.emfcamp.org](https://map.emfcamp.org). Once you have created your village, you can then edit it and go to the map and mark the location. There should be a black plus on a white button in the top right corner which you can use to set where your village intends to setup camp. Please be aware that this does not guarantee you a spot, and just lets people know roughly where you intend to be!
