...
Maps of the EMF site can be found in the information booklets, on boards around the site, and online:

<a href="https://map.emfcamp.org" class="btn btn-primary">See the EMF map</a>
...
**West side**: The western edge of the site has lakes at the north and south. Between them on that side, from south to north, are the Welfare, First Aid and Merch tents, the Greenhouse, and the Lounge. The Shop and the food vendors are also here.
...
**Water and sanitation**:  Drinking water taps, toilets, and shower blocks are placed at multiple points across the site — near the entrance, through the central camping areas, and up toward the northern end — rather than at one or two labeled locations. None of these individual points are named on the map; they're marked only by icon.  
  
**Amenities (full list)**: Bus, first aid, food vendors, green room, information point, lounge, merch/shop, parking, volunteer canteen, and welfare — distributed throughout the site, concentrated more heavily in the central and southern areas.  
  
**Activities (full list)**: Arcade, arts, badge activities, family activities, greenhouse, planetarium, and Q&A sessions — mostly in the central-to-northern part of the site near the workshop tents and Stage B/D.  
  
**Night life (full list)**: Arts, bar, films (Stage C), karaoke (Workshop 6), music (Stage D), Night Market (NullSector), Overbrewed (NullSector), and performance — comedy/theatre (Stage B).  
  
A 0–100m scale bar is included with the map, as well as instructions to visit [map.emfcamp.org](https://map.emfcamp.org) for a more detailed view.
