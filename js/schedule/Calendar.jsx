...
function UsesLotteryIcon({ usesLottery }) {
  ...
  return (
    <span title="This workshop requires you sign up for a ticket">🎟</span>
  );
}
...
function FavouriteButton({ event, toggleFavourite, authenticated }) {
  if (!authenticated) {
    return (
      <p>
        <strong>Log in to add favourites</strong>
      </p>
    );
  }
