...
@pytest.mark.parametrize('inp, other_proposals, expected', [
    # Correctly scheduled
    ...
    ], {'proposed_overlap_100_proposed', 'proposed_overlap_101_scheduled', 'scheduled_overlap_102_proposed', 'scheduled_overlap_103_scheduled'}, id="speaker-violating-causality"),
])
