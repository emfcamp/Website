...
class CalendarEvent(db.Model):
    ...
    favourite_count = column_property(select([func.count(FavouriteCalendarEvents.c.user_id)]).where(
        FavouriteCalendarEvents.c.user_id == id,
    ), deferred=True)
    ...
    def get_export_data(cls):
        ...
        data = {
            ...
            'tables': ['calendar_event', 'favourite_calendar_events'],
        }
