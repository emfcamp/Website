    ...
    def run(self):
        ...
        shift_list = {
            ...
            "Catering": {
                "Volunteer Tent": [
                    {
                        "first": "2018-08-31 07:00:00",
                        "final": "2018-08-31 20:00:00",
                        "min": 2,
                        "max": 5,
                    },
                    {
                        "first": "2018-09-01 07:00:00",
                        "final": "2018-09-01 20:00:00",
                        "min": 2,
                        "max": 5,
                    },
                    {
                        "first": "2018-09-02 07:00:00",
                        "final": "2018-09-02 20:00:00",
                        "min": 2,
                        "max": 5,
                    },
                    {
                        "first": "2018-09-03 07:00:00",
                        "final": "2018-09-03 20:00:00",
                        "min": 2,
                        "max": 5,
                    },
                ]
        ...
        for role_name in roles_list:
            ...
            if role.shifts:
                ...
                for venue_name in venue_list:
                    ...
                    events = (
                        Proposal.query.join(
                            Venue, Proposal.scheduled_venue_id == Venue.id
                        )
