...
class MatchYouTube(Command):
    ...
    video_re = re.compile(r'https://media.ccc.de/v/(?P<prefix>emf[0-9]+)-(?P<id>[0-9]+)-\S+')
        ...
        while True:
            ...
            for video in result['items']:
                ...
                if match:
                    ...
                    if (proposal.youtube_url, proposal.thumbnail_url) != (youtube_url, thumbnail_url):
                        app.logger.info('Updating URLs for %s (%s)', proposal.id, video_id)
